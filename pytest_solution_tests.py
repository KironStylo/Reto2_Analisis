...
def test_problem_2_basic():
    assert problem_2(10) == 44, "La función debería retornar 10 como la suma de los primeros términos pares"
...
test_problem_1_basic()
test_problem_2_basic()
test_problem_3_basic()
test_problem_4_is_palindrome()
test_problem_4_within_expected_range()
test_problem_5_basic()
